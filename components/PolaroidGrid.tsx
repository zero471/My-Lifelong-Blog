        ...
        {categories.map((category, index) => (
          ...
          >
            <motion.div
              ...
              className="relative z-10 flex origin-bottom flex-col border border-gray-100 bg-[#F9F8F6] p-3 pb-6 will-change-transform sm:p-4 sm:pb-8 dark:border-none dark:bg-[#E6E3DB]"
            >
