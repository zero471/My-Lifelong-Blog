  ...
  return (
    <div className="min-h-[80vh] py-12">
      ...
      <div className="mb-12 text-center">
        <h1 className="font-serif text-4xl sm:text-5xl font-medium tracking-tight text-[#2C2C2A]">
          足迹
        </h1>
        <p className="mt-4 font-sans text-base text-gray-500">
          {locationCount} 个城市，无数段记忆
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {travelLocations.map((location) => (
            ...
            >
              ...
              <p className="mt-3 font-sans text-sm leading-relaxed text-gray-600 line-clamp-2">
